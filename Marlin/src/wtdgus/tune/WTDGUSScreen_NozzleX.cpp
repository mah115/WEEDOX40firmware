...
void DGUS_Screen_Nozzle_X::ShowPage(void)
{
    if (pageid == 0)
    {
        dserial.SendString(ADDR_NOFFSET_BUTTON1_TEXT, "1(248)", TEXTLEN_NOFFSET_ITEM);
		dserial.SendString(ADDR_NOFFSET_BUTTON2_TEXT, "2(249)", TEXTLEN_NOFFSET_ITEM);
		dserial.SendString(ADDR_NOFFSET_BUTTON3_TEXT, "3(350)", TEXTLEN_NOFFSET_ITEM);
		dserial.SendString(ADDR_NOFFSET_BUTTON4_TEXT, "4(351)", TEXTLEN_NOFFSET_ITEM);
		dserial.SendString(ADDR_NOFFSET_BUTTON5_TEXT, "5(352)", TEXTLEN_NOFFSET_ITEM);
